...
;;Each robot knows some information about itself:
 ...
 to setup 
   ...
   set numberOfRocks numberOfRocks + (largeClusterRocks * 29)  ;;The total number of individual rocks on the screen is calculated here.
 ...
 to go
   ...
   [
     ...
     ask patches
     [
       ;;Handle the case where the pheromoneCounter is down to 1 seperately so that we don't go into negatives.
